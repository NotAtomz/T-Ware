...
input1.PlaceholderText = "T-Ware_Console_Line.exe"
input1.Text = ""
...
ImageLabel.Image = "http://www.roblox.com/asset/?id=9742675076"
...
scriptcontrols = {
    ...
    ["rejoin"] = function()
        ...
        Players.LocalPlayer:Kick("rejoining so scripts 100% work")
		wait()
...
INTRO.Name = "Intro"
INTRO.Volume = 5
INTRO.SoundId = "rbxassetid://3838588120"
...
--// Make a message
newmessage("T-Ware File Detected!", "The game has been detected with a T-Ware File to use the commands press left alt an type r6 command to use the commands.")
closemessage(10)
